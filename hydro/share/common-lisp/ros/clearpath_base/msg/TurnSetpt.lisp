...
(cl:defmethod cl:initialize-instance :after ((m <TurnSetpt>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnSetpt)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<TurnSetpt> is deprecated: use clearpath_base-msg:TurnSetpt instead.")))
...
(cl:defmethod trans_vel-val ((m <TurnSetpt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:trans_vel-val is deprecated.  Use clearpath_base-msg:trans_vel instead.")
  (trans_vel m))

(cl:ensure-generic-function 'turn_radius-val :lambda-list '(m))
(cl:defmethod turn_radius-val ((m <TurnSetpt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:turn_radius-val is deprecated.  Use clearpath_base-msg:turn_radius instead.")
  (turn_radius m))

(cl:ensure-generic-function 'trans_accel-val :lambda-list '(m))
(cl:defmethod trans_accel-val ((m <TurnSetpt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:trans_accel-val is deprecated.  Use clearpath_base-msg:trans_accel instead.")
  (trans_accel m))
