...
(cl:defmethod cl:initialize-instance :after ((m <DistanceTiming>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DistanceTiming)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<DistanceTiming> is deprecated: use clearpath_base-msg:DistanceTiming instead.")))
...
(cl:defmethod distances-val ((m <DistanceTiming>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:distances-val is deprecated.  Use clearpath_base-msg:distances instead.")
  (distances m))
