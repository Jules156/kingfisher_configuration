...
(cl:defmethod cl:initialize-instance :after ((m <AckermannSetpt>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AckermannSetpt)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<AckermannSetpt> is deprecated: use clearpath_base-msg:AckermannSetpt instead.")))
...
(cl:defmethod steering-val ((m <AckermannSetpt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:steering-val is deprecated.  Use clearpath_base-msg:steering instead.")
  (steering m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <AckermannSetpt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:throttle-val is deprecated.  Use clearpath_base-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <AckermannSetpt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:brake-val is deprecated.  Use clearpath_base-msg:brake instead.")
  (brake m))
