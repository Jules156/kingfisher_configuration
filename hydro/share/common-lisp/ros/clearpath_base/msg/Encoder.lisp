...
(cl:defmethod cl:initialize-instance :after ((m <Encoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<Encoder> is deprecated: use clearpath_base-msg:Encoder instead.")))

(cl:ensure-generic-function 'travel-val :lambda-list '(m))
(cl:defmethod travel-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:travel-val is deprecated.  Use clearpath_base-msg:travel instead.")
  (travel m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:speed-val is deprecated.  Use clearpath_base-msg:speed instead.")
  (speed m))
