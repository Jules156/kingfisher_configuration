...
(cl:defmethod cl:initialize-instance :after ((m <PowerSource>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PowerSource)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<PowerSource> is deprecated: use clearpath_base-msg:PowerSource instead.")))

(cl:ensure-generic-function 'charge-val :lambda-list '(m))
(cl:defmethod charge-val ((m <PowerSource>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:charge-val is deprecated.  Use clearpath_base-msg:charge instead.")
  (charge m))

(cl:ensure-generic-function 'capacity-val :lambda-list '(m))
(cl:defmethod capacity-val ((m <PowerSource>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:capacity-val is deprecated.  Use clearpath_base-msg:capacity instead.")
  (capacity m))

(cl:ensure-generic-function 'present-val :lambda-list '(m))
(cl:defmethod present-val ((m <PowerSource>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:present-val is deprecated.  Use clearpath_base-msg:present instead.")
  (present m))

(cl:ensure-generic-function 'in_use-val :lambda-list '(m))
(cl:defmethod in_use-val ((m <PowerSource>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:in_use-val is deprecated.  Use clearpath_base-msg:in_use instead.")
  (in_use m))

(cl:ensure-generic-function 'description-val :lambda-list '(m))
(cl:defmethod description-val ((m <PowerSource>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:description-val is deprecated.  Use clearpath_base-msg:description instead.")
  (description m))
