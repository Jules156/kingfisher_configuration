...
(cl:defclass <PowerStatus> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (sources
    :reader sources
    :initarg :sources
    :type (cl:vector clearpath_base-msg:PowerSource)
   :initform (cl:make-array 0 :element-type 'clearpath_base-msg:PowerSource :initial-element (cl:make-instance 'clearpath_base-msg:PowerSource))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PowerStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PowerStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<PowerStatus> is deprecated: use clearpath_base-msg:PowerStatus instead.")))
...
(cl:defmethod sources-val ((m <PowerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:sources-val is deprecated.  Use clearpath_base-msg:sources instead.")
  (sources m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PowerStatus>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'sources)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'clearpath_base-msg:PowerSource))
