...
(cl:defmethod cl:initialize-instance :after ((m <DifferentialOutput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DifferentialOutput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<DifferentialOutput> is deprecated: use clearpath_base-msg:DifferentialOutput instead.")))
...
(cl:defmethod left-val ((m <DifferentialOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:left-val is deprecated.  Use clearpath_base-msg:left instead.")
  (left m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <DifferentialOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:right-val is deprecated.  Use clearpath_base-msg:right instead.")
  (right m))
