...
(cl:defmethod cl:initialize-instance :after ((m <RawEncoders>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RawEncoders)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<RawEncoders> is deprecated: use clearpath_base-msg:RawEncoders instead.")))
...
(cl:defmethod ticks-val ((m <RawEncoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:ticks-val is deprecated.  Use clearpath_base-msg:ticks instead.")
  (ticks m))
