...
(cl:defmethod cl:initialize-instance :after ((m <PlatformInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlatformInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<PlatformInfo> is deprecated: use clearpath_base-msg:PlatformInfo instead.")))
...
(cl:defmethod revision-val ((m <PlatformInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:revision-val is deprecated.  Use clearpath_base-msg:revision instead.")
  (revision m))
