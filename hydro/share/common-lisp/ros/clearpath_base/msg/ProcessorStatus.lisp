...
(cl:defmethod cl:initialize-instance :after ((m <ProcessorStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ProcessorStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<ProcessorStatus> is deprecated: use clearpath_base-msg:ProcessorStatus instead.")))
...
(cl:defmethod errors-val ((m <ProcessorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:errors-val is deprecated.  Use clearpath_base-msg:errors instead.")
  (errors m))
