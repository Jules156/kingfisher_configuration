...
(cl:defmethod cl:initialize-instance :after ((m <PlatformName>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlatformName)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<PlatformName> is deprecated: use clearpath_base-msg:PlatformName instead.")))
