...
(cl:defmethod cl:initialize-instance :after ((m <SafetyStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SafetyStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<SafetyStatus> is deprecated: use clearpath_base-msg:SafetyStatus instead.")))
...
(cl:defmethod flags-val ((m <SafetyStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:flags-val is deprecated.  Use clearpath_base-msg:flags instead.")
  (flags m))

(cl:ensure-generic-function 'estop-val :lambda-list '(m))
(cl:defmethod estop-val ((m <SafetyStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:estop-val is deprecated.  Use clearpath_base-msg:estop instead.")
  (estop m))
