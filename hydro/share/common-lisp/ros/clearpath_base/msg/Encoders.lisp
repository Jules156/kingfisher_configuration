...
(cl:defclass <Encoders> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (encoders
    :reader encoders
    :initarg :encoders
    :type (cl:vector clearpath_base-msg:Encoder)
   :initform (cl:make-array 0 :element-type 'clearpath_base-msg:Encoder :initial-element (cl:make-instance 'clearpath_base-msg:Encoder))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Encoders>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoders)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<Encoders> is deprecated: use clearpath_base-msg:Encoders instead.")))
...
(cl:defmethod encoders-val ((m <Encoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:encoders-val is deprecated.  Use clearpath_base-msg:encoders instead.")
  (encoders m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Encoders>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'encoders)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'clearpath_base-msg:Encoder))
