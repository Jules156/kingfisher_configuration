...
(cl:defmethod cl:initialize-instance :after ((m <FirmwareInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FirmwareInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<FirmwareInfo> is deprecated: use clearpath_base-msg:FirmwareInfo instead.")))
...
(cl:defmethod firmware_major-val ((m <FirmwareInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:firmware_major-val is deprecated.  Use clearpath_base-msg:firmware_major instead.")
  (firmware_major m))

(cl:ensure-generic-function 'firmware_minor-val :lambda-list '(m))
(cl:defmethod firmware_minor-val ((m <FirmwareInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:firmware_minor-val is deprecated.  Use clearpath_base-msg:firmware_minor instead.")
  (firmware_minor m))

(cl:ensure-generic-function 'protocol_major-val :lambda-list '(m))
(cl:defmethod protocol_major-val ((m <FirmwareInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:protocol_major-val is deprecated.  Use clearpath_base-msg:protocol_major instead.")
  (protocol_major m))

(cl:ensure-generic-function 'protocol_minor-val :lambda-list '(m))
(cl:defmethod protocol_minor-val ((m <FirmwareInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:protocol_minor-val is deprecated.  Use clearpath_base-msg:protocol_minor instead.")
  (protocol_minor m))

(cl:ensure-generic-function 'firmware_write_time-val :lambda-list '(m))
(cl:defmethod firmware_write_time-val ((m <FirmwareInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_base-msg:firmware_write_time-val is deprecated.  Use clearpath_base-msg:firmware_write_time instead.")
