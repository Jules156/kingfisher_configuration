...
(cl:defmethod cl:initialize-instance :after ((m <Distance>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Distance)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_base-msg:<Distance> is deprecated: use clearpath_base-msg:Distance instead.")))
