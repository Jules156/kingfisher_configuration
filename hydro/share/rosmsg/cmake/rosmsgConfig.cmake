...
if("FALSE" STREQUAL "TRUE")
  set(rosmsg_SOURCE_PREFIX /tmp/buildd/ros-hydro-rosmsg-1.10.12-0precise-20150329-1434)
  set(rosmsg_DEVEL_PREFIX /tmp/buildd/ros-hydro-rosmsg-1.10.12-0precise-20150329-1434/obj-i686-linux-gnu/devel)
  set(rosmsg_INSTALL_PREFIX "")
  set(rosmsg_PREFIX ${rosmsg_DEVEL_PREFIX})
else()
  set(rosmsg_SOURCE_PREFIX "")
  set(rosmsg_DEVEL_PREFIX "")
  set(rosmsg_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosmsg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
