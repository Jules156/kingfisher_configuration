...
if("FALSE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /tmp/buildd/ros-hydro-image-proc-1.11.11-0precise-20150517-0901)
  set(image_proc_DEVEL_PREFIX /tmp/buildd/ros-hydro-image-proc-1.11.11-0precise-20150517-0901/obj-i686-linux-gnu/devel)
  ...
  set(image_proc_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/opt/ros/hydro/include/opencv;/opt/ros/hydro/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
