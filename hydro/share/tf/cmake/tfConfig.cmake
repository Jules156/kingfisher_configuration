...
if("FALSE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /tmp/buildd/ros-hydro-tf-1.10.8-1precise-20150329-1445)
  set(tf_DEVEL_PREFIX /tmp/buildd/ros-hydro-tf-1.10.8-1precise-20150329-1445/obj-i686-linux-gnu/devel)
  set(tf_INSTALL_PREFIX "")
  set(tf_PREFIX ${tf_DEVEL_PREFIX})
else()
  set(tf_SOURCE_PREFIX "")
  set(tf_DEVEL_PREFIX "")
  set(tf_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@willowgarage.com>' to fix it.")
    endif()
