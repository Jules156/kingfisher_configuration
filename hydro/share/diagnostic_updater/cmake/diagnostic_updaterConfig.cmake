...
if("FALSE" STREQUAL "TRUE")
  set(diagnostic_updater_SOURCE_PREFIX /tmp/buildd/ros-hydro-diagnostic-updater-1.8.8-0precise-20150808-0100)
  set(diagnostic_updater_DEVEL_PREFIX /tmp/buildd/ros-hydro-diagnostic-updater-1.8.8-0precise-20150808-0100/obj-i686-linux-gnu/devel)
  ...
  set(diagnostic_updater_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
