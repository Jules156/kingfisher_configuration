...
if("FALSE" STREQUAL "TRUE")
  set(um6_SOURCE_PREFIX /tmp/buildd/ros-hydro-um6-0.0.2-0precise-20150328-0714)
  set(um6_DEVEL_PREFIX /tmp/buildd/ros-hydro-um6-0.0.2-0precise-20150328-0714/obj-i686-linux-gnu/devel)
  set(um6_INSTALL_PREFIX "")
  set(um6_PREFIX ${um6_DEVEL_PREFIX})
else()
  set(um6_SOURCE_PREFIX "")
  set(um6_DEVEL_PREFIX "")
  set(um6_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'um6' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
    endif()
