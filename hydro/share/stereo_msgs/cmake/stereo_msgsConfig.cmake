...
if("FALSE" STREQUAL "TRUE")
  set(stereo_msgs_SOURCE_PREFIX /tmp/buildd/ros-hydro-stereo-msgs-1.10.6-0precise-20150328-0810)
  set(stereo_msgs_DEVEL_PREFIX /tmp/buildd/ros-hydro-stereo-msgs-1.10.6-0precise-20150328-0810/obj-i686-linux-gnu/devel)
  ...
  set(stereo_msgs_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
