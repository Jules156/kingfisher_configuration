...
if("FALSE" STREQUAL "TRUE")
  set(camera1394_SOURCE_PREFIX /tmp/buildd/ros-hydro-camera1394-1.9.5-1precise-20150808-0614)
  set(camera1394_DEVEL_PREFIX /tmp/buildd/ros-hydro-camera1394-1.9.5-1precise-20150808-0614/obj-i686-linux-gnu/devel)
  ...
  set(camera1394_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'camera1394' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
    endif()
...
set(camera1394_EXPORTED_TARGETS "camera1394_gencfg")
...
set(depends "camera_info_manager;diagnostic_updater;dynamic_reconfigure;image_transport;nodelet;roscpp;sensor_msgs;tf")
