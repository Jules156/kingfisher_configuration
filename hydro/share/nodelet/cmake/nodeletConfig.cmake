...
if("FALSE" STREQUAL "TRUE")
  set(nodelet_SOURCE_PREFIX /tmp/buildd/ros-hydro-nodelet-1.8.6-0precise-20150329-0144)
  set(nodelet_DEVEL_PREFIX /tmp/buildd/ros-hydro-nodelet-1.8.6-0precise-20150329-0144/obj-i686-linux-gnu/devel)
  set(nodelet_INSTALL_PREFIX "")
  set(nodelet_PREFIX ${nodelet_DEVEL_PREFIX})
else()
  set(nodelet_SOURCE_PREFIX "")
  set(nodelet_DEVEL_PREFIX "")
  set(nodelet_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/usr/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
