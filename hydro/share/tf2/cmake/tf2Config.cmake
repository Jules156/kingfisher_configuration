...
if("FALSE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /tmp/buildd/ros-hydro-tf2-0.4.12-0precise-20150328-0804)
  set(tf2_DEVEL_PREFIX /tmp/buildd/ros-hydro-tf2-0.4.12-0precise-20150328-0804/obj-i686-linux-gnu/devel)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/opt/ros/hydro/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(tf2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tf2;/opt/ros/hydro/lib/libconsole_bridge.so")
