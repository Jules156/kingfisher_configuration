...
if("FALSE" STREQUAL "TRUE")
  set(rosgraph_SOURCE_PREFIX /tmp/buildd/ros-hydro-rosgraph-1.10.12-0precise-20141231-1916)
  set(rosgraph_DEVEL_PREFIX /tmp/buildd/ros-hydro-rosgraph-1.10.12-0precise-20141231-1916/obj-i686-linux-gnu/devel)
  set(rosgraph_INSTALL_PREFIX "")
  set(rosgraph_PREFIX ${rosgraph_DEVEL_PREFIX})
else()
  set(rosgraph_SOURCE_PREFIX "")
  set(rosgraph_DEVEL_PREFIX "")
  set(rosgraph_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
