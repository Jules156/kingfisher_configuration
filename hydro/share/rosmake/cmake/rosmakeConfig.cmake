...
if("FALSE" STREQUAL "TRUE")
  set(rosmake_SOURCE_PREFIX /tmp/buildd/ros-hydro-rosmake-1.10.11-0precise-20141231-1937)
  set(rosmake_DEVEL_PREFIX /tmp/buildd/ros-hydro-rosmake-1.10.11-0precise-20141231-1937/obj-i686-linux-gnu/devel)
  set(rosmake_INSTALL_PREFIX "")
  set(rosmake_PREFIX ${rosmake_DEVEL_PREFIX})
else()
  set(rosmake_SOURCE_PREFIX "")
  set(rosmake_DEVEL_PREFIX "")
  set(rosmake_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosmake' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
