...
if("FALSE" STREQUAL "TRUE")
  set(driver_base_SOURCE_PREFIX /tmp/buildd/ros-hydro-driver-base-1.6.8-0precise-20150808-0611)
  set(driver_base_DEVEL_PREFIX /tmp/buildd/ros-hydro-driver-base-1.6.8-0precise-20150808-0611/obj-i686-linux-gnu/devel)
  ...
  set(driver_base_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/usr/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
    endif()
