...
if("FALSE" STREQUAL "TRUE")
  set(self_test_SOURCE_PREFIX /tmp/buildd/ros-hydro-self-test-1.8.8-0precise-20150808-0109)
  set(self_test_DEVEL_PREFIX /tmp/buildd/ros-hydro-self-test-1.8.8-0precise-20150808-0109/obj-i686-linux-gnu/devel)
  ...
  set(self_test_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'self_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Brice Rebsamen <brice.rebsamen@gmail.com>, Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
