...
if("FALSE" STREQUAL "TRUE")
  set(rosnode_SOURCE_PREFIX /tmp/buildd/ros-hydro-rosnode-1.10.12-0precise-20150329-1405)
  set(rosnode_DEVEL_PREFIX /tmp/buildd/ros-hydro-rosnode-1.10.12-0precise-20150329-1405/obj-i686-linux-gnu/devel)
  set(rosnode_INSTALL_PREFIX "")
  set(rosnode_PREFIX ${rosnode_DEVEL_PREFIX})
else()
  set(rosnode_SOURCE_PREFIX "")
  set(rosnode_DEVEL_PREFIX "")
  set(rosnode_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
