...
if("FALSE" STREQUAL "TRUE")
  set(message_runtime_SOURCE_PREFIX /tmp/buildd/ros-hydro-message-runtime-0.4.12-0precise-20150101-0048)
  set(message_runtime_DEVEL_PREFIX /tmp/buildd/ros-hydro-message-runtime-0.4.12-0precise-20150101-0048/obj-i686-linux-gnu/devel)
  ...
  set(message_runtime_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'message_runtime' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
