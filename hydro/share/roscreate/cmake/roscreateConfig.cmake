...
if("FALSE" STREQUAL "TRUE")
  set(roscreate_SOURCE_PREFIX /tmp/buildd/ros-hydro-roscreate-1.10.11-0precise-20141231-1941)
  set(roscreate_DEVEL_PREFIX /tmp/buildd/ros-hydro-roscreate-1.10.11-0precise-20141231-1941/obj-i686-linux-gnu/devel)
  ...
  set(roscreate_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'roscreate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
