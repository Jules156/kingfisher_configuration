...
if("FALSE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX /tmp/buildd/ros-hydro-rostest-1.10.12-0precise-20150329-0156)
  set(rostest_DEVEL_PREFIX /tmp/buildd/ros-hydro-rostest-1.10.12-0precise-20150329-0156/obj-i686-linux-gnu/devel)
  set(rostest_INSTALL_PREFIX "")
  set(rostest_PREFIX ${rostest_DEVEL_PREFIX})
else()
  set(rostest_SOURCE_PREFIX "")
  set(rostest_DEVEL_PREFIX "")
  set(rostest_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/usr/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
