...
if("FALSE" STREQUAL "TRUE")
  set(zeroconf_avahi_SOURCE_PREFIX /tmp/buildd/ros-hydro-zeroconf-avahi-0.2.3-0precise-20150328-0726)
  set(zeroconf_avahi_DEVEL_PREFIX /tmp/buildd/ros-hydro-zeroconf-avahi-0.2.3-0precise-20150328-0726/obj-i686-linux-gnu/devel)
  ...
  set(zeroconf_avahi_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/usr/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'zeroconf_avahi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
    _list_append_unique(zeroconf_avahi_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "zeroconf_avahi;/usr/lib/libboost_thread-mt.so;pthread")
