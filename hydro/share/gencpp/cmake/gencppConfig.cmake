...
if("FALSE" STREQUAL "TRUE")
  set(gencpp_SOURCE_PREFIX /tmp/buildd/ros-hydro-gencpp-0.4.17-0precise-20141231-1951)
  set(gencpp_DEVEL_PREFIX /tmp/buildd/ros-hydro-gencpp-0.4.17-0precise-20141231-1951/obj-i686-linux-gnu/devel)
  set(gencpp_INSTALL_PREFIX "")
  set(gencpp_PREFIX ${gencpp_DEVEL_PREFIX})
else()
  set(gencpp_SOURCE_PREFIX "")
  set(gencpp_DEVEL_PREFIX "")
  set(gencpp_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'gencpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
