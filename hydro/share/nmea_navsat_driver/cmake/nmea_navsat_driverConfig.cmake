...
if("FALSE" STREQUAL "TRUE")
  set(nmea_navsat_driver_SOURCE_PREFIX /tmp/buildd/ros-hydro-nmea-navsat-driver-0.3.3-0precise-20150328-0750)
  set(nmea_navsat_driver_DEVEL_PREFIX /tmp/buildd/ros-hydro-nmea-navsat-driver-0.3.3-0precise-20150328-0750/obj-i686-linux-gnu/devel)
  ...
  set(nmea_navsat_driver_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'nmea_navsat_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Eric Perko <eric@ericperko.com>' to fix it.")
    endif()
