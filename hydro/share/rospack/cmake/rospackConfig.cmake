...
if("FALSE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /tmp/buildd/ros-hydro-rospack-2.1.25-0precise-20141231-1936)
  set(rospack_DEVEL_PREFIX /tmp/buildd/ros-hydro-rospack-2.1.25-0precise-20141231-1936/obj-i686-linux-gnu/devel)
  set(rospack_INSTALL_PREFIX "")
  set(rospack_PREFIX ${rospack_DEVEL_PREFIX})
else()
  set(rospack_SOURCE_PREFIX "")
  set(rospack_DEVEL_PREFIX "")
  set(rospack_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/usr/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rospack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rospack;tinyxml;/usr/lib/libpython2.7.so;/usr/lib/libboost_filesystem-mt.so;/usr/lib/libboost_program_options-mt.so;/usr/lib/libboost_system-mt.so")
