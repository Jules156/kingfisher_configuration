...
if("FALSE" STREQUAL "TRUE")
  set(pcl_ros_SOURCE_PREFIX /tmp/buildd/ros-hydro-pcl-ros-1.1.11-0precise-20150329-1615)
  set(pcl_ros_DEVEL_PREFIX /tmp/buildd/ros-hydro-pcl-ros-1.1.11-0precise-20150329-1615/obj-i686-linux-gnu/devel)
  set(pcl_ros_INSTALL_PREFIX "")
  set(pcl_ros_PREFIX ${pcl_ros_DEVEL_PREFIX})
else()
  set(pcl_ros_SOURCE_PREFIX "")
  set(pcl_ros_DEVEL_PREFIX "")
  set(pcl_ros_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/usr/include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include/ni;/usr/include/vtk-5.8;/usr/include/qhull" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'pcl_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Bill Morris <bill@neautomation.com>' to fix it.")
    endif()
