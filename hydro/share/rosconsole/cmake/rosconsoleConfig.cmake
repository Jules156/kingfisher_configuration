...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /tmp/buildd/ros-hydro-rosconsole-1.10.12-0precise-20150327-1732)
  set(rosconsole_DEVEL_PREFIX /tmp/buildd/ros-hydro-rosconsole-1.10.12-0precise-20150327-1732/obj-i686-linux-gnu/devel)
  ...
  set(rosconsole_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/usr/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole;rosconsole_log4cxx;rosconsole_backend_interface;/usr/lib/liblog4cxx.so;/usr/lib/libboost_regex-mt.so;/usr/lib/libboost_system-mt.so;/usr/lib/libboost_thread-mt.so;pthread")
