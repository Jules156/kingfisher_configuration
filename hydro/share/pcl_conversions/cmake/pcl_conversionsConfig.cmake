...
if("FALSE" STREQUAL "TRUE")
  set(pcl_conversions_SOURCE_PREFIX /tmp/buildd/ros-hydro-pcl-conversions-0.1.6-0precise-20150328-0721)
  set(pcl_conversions_DEVEL_PREFIX /tmp/buildd/ros-hydro-pcl-conversions-0.1.6-0precise-20150328-0721/obj-i686-linux-gnu/devel)
  ...
  set(pcl_conversions_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/usr/include/eigen3;/usr/include;/usr/include/pcl-1.7" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'pcl_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'William Woodall <william@osrfoundation.org>' to fix it.")
    endif()
