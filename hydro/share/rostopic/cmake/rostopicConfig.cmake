...
if("FALSE" STREQUAL "TRUE")
  set(rostopic_SOURCE_PREFIX /tmp/buildd/ros-hydro-rostopic-1.10.12-0precise-20150329-0226)
  set(rostopic_DEVEL_PREFIX /tmp/buildd/ros-hydro-rostopic-1.10.12-0precise-20150329-0226/obj-i686-linux-gnu/devel)
  set(rostopic_INSTALL_PREFIX "")
  set(rostopic_PREFIX ${rostopic_DEVEL_PREFIX})
else()
  set(rostopic_SOURCE_PREFIX "")
  set(rostopic_DEVEL_PREFIX "")
  set(rostopic_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rostopic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
