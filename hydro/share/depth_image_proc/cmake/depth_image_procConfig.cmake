...
if("FALSE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /tmp/buildd/ros-hydro-depth-image-proc-1.11.11-0precise-20150517-0833)
  set(depth_image_proc_DEVEL_PREFIX /tmp/buildd/ros-hydro-depth-image-proc-1.11.11-0precise-20150517-0833/obj-i686-linux-gnu/devel)
  ...
  set(depth_image_proc_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
