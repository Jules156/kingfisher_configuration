...
if("FALSE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /tmp/buildd/ros-hydro-pluginlib-1.9.24-0precise-20150328-0709)
  set(pluginlib_DEVEL_PREFIX /tmp/buildd/ros-hydro-pluginlib-1.9.24-0precise-20150328-0709/obj-i686-linux-gnu/devel)
  ...
  set(pluginlib_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include;/usr/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tinyxml;/usr/lib/libboost_filesystem-mt.so;/usr/lib/libboost_system-mt.so")
