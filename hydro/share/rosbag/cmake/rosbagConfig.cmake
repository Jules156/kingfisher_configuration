...
if("FALSE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /tmp/buildd/ros-hydro-rosbag-1.10.12-0precise-20150329-0215)
  set(rosbag_DEVEL_PREFIX /tmp/buildd/ros-hydro-rosbag-1.10.12-0precise-20150329-0215/obj-i686-linux-gnu/devel)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
