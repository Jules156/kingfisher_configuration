...
if("FALSE" STREQUAL "TRUE")
  set(geometry_msgs_SOURCE_PREFIX /tmp/buildd/ros-hydro-geometry-msgs-1.10.6-0precise-20150327-1749)
  set(geometry_msgs_DEVEL_PREFIX /tmp/buildd/ros-hydro-geometry-msgs-1.10.6-0precise-20150327-1749/obj-i686-linux-gnu/devel)
  ...
  set(geometry_msgs_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'geometry_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
