...
if("FALSE" STREQUAL "TRUE")
  set(tf2_ros_SOURCE_PREFIX /tmp/buildd/ros-hydro-tf2-ros-0.4.12-0precise-20150329-1423)
  set(tf2_ros_DEVEL_PREFIX /tmp/buildd/ros-hydro-tf2-ros-0.4.12-0precise-20150329-1423/obj-i686-linux-gnu/devel)
  set(tf2_ros_INSTALL_PREFIX "")
  set(tf2_ros_PREFIX ${tf2_ros_DEVEL_PREFIX})
else()
  set(tf2_ros_SOURCE_PREFIX "")
  set(tf2_ros_DEVEL_PREFIX "")
  set(tf2_ros_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
