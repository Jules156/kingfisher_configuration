...
if("FALSE" STREQUAL "TRUE")
  set(roslang_SOURCE_PREFIX /tmp/buildd/ros-hydro-roslang-1.10.11-0precise-20141231-1951)
  set(roslang_DEVEL_PREFIX /tmp/buildd/ros-hydro-roslang-1.10.11-0precise-20141231-1951/obj-i686-linux-gnu/devel)
  set(roslang_INSTALL_PREFIX "")
  set(roslang_PREFIX ${roslang_DEVEL_PREFIX})
else()
  set(roslang_SOURCE_PREFIX "")
  set(roslang_DEVEL_PREFIX "")
  set(roslang_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'roslang' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
