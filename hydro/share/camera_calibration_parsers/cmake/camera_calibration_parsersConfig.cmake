...
if("FALSE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX /tmp/buildd/ros-hydro-camera-calibration-parsers-1.11.5-0precise-20150514-1627)
  set(camera_calibration_parsers_DEVEL_PREFIX /tmp/buildd/ros-hydro-camera-calibration-parsers-1.11.5-0precise-20150514-1627/obj-i686-linux-gnu/devel)
  ...
  set(camera_calibration_parsers_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
