...
if("FALSE" STREQUAL "TRUE")
  set(rosboost_cfg_SOURCE_PREFIX /tmp/buildd/ros-hydro-rosboost-cfg-1.10.11-0precise-20141231-1956)
  set(rosboost_cfg_DEVEL_PREFIX /tmp/buildd/ros-hydro-rosboost-cfg-1.10.11-0precise-20141231-1956/obj-i686-linux-gnu/devel)
  ...
  set(rosboost_cfg_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosboost_cfg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
