...
if("FALSE" STREQUAL "TRUE")
  set(bond_SOURCE_PREFIX /tmp/buildd/ros-hydro-bond-1.7.16-0precise-20150327-1738)
  set(bond_DEVEL_PREFIX /tmp/buildd/ros-hydro-bond-1.7.16-0precise-20150327-1738/obj-i686-linux-gnu/devel)
  set(bond_INSTALL_PREFIX "")
  set(bond_PREFIX ${bond_DEVEL_PREFIX})
else()
  set(bond_SOURCE_PREFIX "")
  set(bond_DEVEL_PREFIX "")
  set(bond_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'bond' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
