...
if("FALSE" STREQUAL "TRUE")
  set(topic_tools_SOURCE_PREFIX /tmp/buildd/ros-hydro-topic-tools-1.10.12-0precise-20150329-0204)
  set(topic_tools_DEVEL_PREFIX /tmp/buildd/ros-hydro-topic-tools-1.10.12-0precise-20150329-0204/obj-i686-linux-gnu/devel)
  ...
  set(topic_tools_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'topic_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
