...
if("FALSE" STREQUAL "TRUE")
  set(rosbash_SOURCE_PREFIX /tmp/buildd/ros-hydro-rosbash-1.10.11-0precise-20141231-1934)
  set(rosbash_DEVEL_PREFIX /tmp/buildd/ros-hydro-rosbash-1.10.11-0precise-20141231-1934/obj-i686-linux-gnu/devel)
  set(rosbash_INSTALL_PREFIX "")
  set(rosbash_PREFIX ${rosbash_DEVEL_PREFIX})
else()
  set(rosbash_SOURCE_PREFIX "")
  set(rosbash_DEVEL_PREFIX "")
  set(rosbash_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosbash' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
